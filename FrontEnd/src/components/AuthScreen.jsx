...
const AuthScreen = ({ onLoginSuccess, theme, toggleTheme, onForgotPassword }) => {
  ...
  return (
    <div className="flex-1 flex flex-col items-center p-4 sm:p-6 bg-gray-50 dark:bg-gray-900 transition-colors duration-500 overflow-y-auto relative">
            ...
            <div>
              ...
              {isLoginView && (
                <div className="text-right mt-1">
                  <button type="button" onClick={onForgotPassword} className="text-sm text-blue-600 dark:text-blue-400 hover:underline">
                    Forgot Password?
                  </button>
                </div>
              )}
